...
export default function AlertComponent({alert , changeAlert , message }){
    ...
    return(
        <> 
            <div className={alert ? "w-full h-screen fixed bg-black opacity-20 top-0 left-0 z-[150]  " : ""} ></div>
            <div  className={alert ? "w-full z-[151] h-screen fixed top-0 left-0 flex justify-center flex-col items-center " : ""} >
                <div id="alert-additional-content-5" className={ `z-[151] min-[0px]:w-9/12 md:w-5/12 p-4 border border-gray-300 rounded-lg bg-gray-50 dark:border-gray-600 dark:bg-gray-800 relative ${alert ? "block" : "hidden" } ` } role="alert">
